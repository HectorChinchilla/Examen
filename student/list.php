                        ...
                        foreach ($result as $values) {
                            if ($values["is_active"] == 1) {
                                echo "<tr><td>"
                                    ...
                                    . "</td><td>"
                                    . "<a href='../src/student_control/delete.php?id="
                                    . $values["id"]
                                    . "' class = 'button is-small is-danger is-outlined'><span class='icon is-small'><i class='fas fa-times'></i></span><span>Eliminar</span></a></td>"
                                    . "</td><td>"
                                    . "<a href='../student/perfil.php?id="
                                    . $values["id"]
                                    . "' class = 'button is-small is-info is-outlined'><span class='icon has-text-info'><i class='fas fa-info-circle'></i></span><span>Detalle</span></a></td>";
                            }
                        }
                        ?>
                    </tbody>
